...
const solutions = [
  {
    icon: <TrendingDown className="w-7 h-7 text-isa-pink-500" />,
  ...
  {
    icon: <Plug className="w-7 h-7 text-isa-pink-700" />,
...
export default function ParaParceirosPage() {
  ...
  return (
    <>
      {/* Hero */}
      <section className="relative bg-gradient-to-br from-isa-gray-900 via-isa-gray-800 to-isa-dark text-white pt-32 pb-20 overflow-hidden">
        <div className="absolute inset-0 opacity-5">
          <div className="absolute top-0 left-0 w-full h-full bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-isa-pink-500 to-transparent" />
        </div>
      ...
      {/* Benefits list */}
      <section className="py-16 bg-isa-dark text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-isa-pink-200 text-lg mb-8">
              ...
              <ul className="space-y-3">
                {benefits.map((b) => (
                  <li key={b} className="flex items-center gap-3">
                    ...
                    <span className="text-isa-pink-100">{b}</span>
                  </li>
                ))}
              </ul>
            </div>
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                >
                  ...
                  <p className="text-isa-pink-200 text-sm">{stat.label}</p>
                </div>
              ))}
            </div>
          </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full border border-isa-gray-200 rounded-button px-4 py-2.5 text-sm text-isa-gray-800 focus:outline-none focus:ring-2 focus:ring-isa-pink-500"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full border border-isa-gray-200 rounded-button px-4 py-2.5 text-sm text-isa-gray-800 focus:outline-none focus:ring-2 focus:ring-isa-pink-500 resize-none"
